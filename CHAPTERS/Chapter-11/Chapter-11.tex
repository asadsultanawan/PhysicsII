...
\subsubsection{Electrodynamics/Current Electricity}
\textit{\textbf{
...
Let $\vec{F_{12}}$ is the force exerted by charge `$q_{2}$' on charge `$q_{1}$' (subscript as, `12' means by 2 on 1)
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = 0.8]{Images/Chapter-11/11.4a}}
      \caption{Positive Charge}
      \label{fig:11.4a}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = 0.8]{Images/Chapter-11/11.4b}}
...
\begin{figure}[htbp]
  \centering
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = 0.8]{Images/Chapter-11/11.6a.png}}
      \caption{For two negative charges}
      \label{fig:11.6(a)}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = 0.8]{Images/Chapter-11/11.6b.png}}
...
We know that all the flux lines coming from `$q_{1}$’ passes through the surface `S’,
...
\end{equation}
Put back value of $\Delta r$ in \ref{eq:11.51}:
\begin{equation}
...
\end{equation}
This gives the on a test charge $q$ when it is brought from one
...
\subsection*{Another unit of Electric Field}
...
the battery.
\subsubsection{Mechanism of Charging}
...
\subsubsection*{Dependence of Capacitance}
...
\subsubsection{Mathematical Expression for Capacitance}
...
\end{enumerate}
Above equation is for capacitance of a parallel plate capacitor
...
\end{enumerate}
\subsubsection{Series Combination of Capacitors}
\textit{
\textbf{
...
\end{enumerate}
\paragraph{Equivalent Capacitance of Series Combination:}
...
\begin{equation}\nonumber
  Q =  C_{eq}V
\end{equation}
Now as the charge deposited on the plates of each capacitor is same.
...
\begin{figure}[H]
  ...
  \label{fig:11.33}
\end{figure}
\paragraph{Characteristics of Parallel Combination of Capacitors}
...
The voltage across each capacitor is same. Charge flowing from the voltage
...
\subsection*{Effect on Electric Field}
...
\newpage
\section{Charging and Discharging of a Capacitor}
...
\begin{figure}[H]
  ...
  \label{fig:11.37}
\end{figure}
\subsubsection{Voltage Curve for Capacitor during Charging}
As we know that:
\begin{equation}\notag
  q = CV_{C}
\end{equation}
...
\begin{figure}[H]
  ...
  \label{fig:11.38}
\end{figure}
%\subsubsection{Current Curve for Capacitor during Charging}
% Taking rate of change of equation \ref{eq:11.88}
% and using a result directly from calculus:
% \begin{equation}\notag
%   \frac{d}{dt}(e^{u}) = e^{u}\frac{du}{dt}
% \end{equation}
% Hence,
% \begin{equation}\notag
%   \frac{dq}{dt} = q_{o}(e^{\frac{-t}{RC}})(\frac{-1}{RC})
% \end{equation}
% \begin{equation}\notag
%   I = \frac{q_{o}}{RC}(e^{\frac{-t}{RC}})
% \end{equation}
% When $t = 0,\:I = I_{o} = \frac{q_{o}}{RC} = \frac{V_o}{R}$
% \newline
% Hence, we can write:
% \begin{mybox}{red}{}
% \begin{equation}\label{11.90}
%   I = I_{0}e^{\frac{-t}{RC}} = \frac{V_{o}}{R}e^{\frac{-t}{RC}}
% \end{equation}
% \end{mybox}
% \noindent When $t = \infty,\:I = 0$.
% \newline
% From above results, we can conclude that current is maximum at start,
% maximum charge flows to plates and then gradually, charge flow reduces i.e.
% current reduces and in infinite time, it reduces to zero.
% Hence the current curve for charging will have
% a reverse behaviour to that of charging and discharging curves.

\subsubsection{Voltage Curve for Resistor during Charging}
...
\begin{figure}[H]
  ...
  \label{fig:11.39}
\end{figure}
\subsubsection{Current Curve during Charging}
...
\subsubsection{Time constant ($RC$)}
\textit{
  \textbf{
...
$q$. 
\subsubsection{Voltage Curve for Capacitor during Discharging}
...
\begin{mybox}{red}{}
  ...
  \end{equation}
\end{mybox}
\subsubsection{Current Curve during Discharging}
...
\begin{figure}[htbp]
  \centering
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[width = 4.5cm, height = 2.5cm]{Images/Chapter-11/11.42a}}
      \caption{Voltage across capacitor during discharging}
      \label{fig:11.42a}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[width = 4.5cm, height = 2.5cm]{Images/Chapter-11/11.42b}}
      \caption{Current flowing through the circuit during discharging}
      \label{fig:11.42b}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\textwidth}
    \fbox{\includegraphics[width = 4.5cm, height = 2.5cm]{Images/Chapter-11/11.42c}}
...
\begin{equation}\notag
  ...
  \end{split}
\end{equation}
\subsection*{Effect of Larger \& Smaller $\tau = RC$}
...
\begin{figure}[htbp]
  \centering
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = .85]{Images/Chapter-11/11.43a}}
      \caption{$q$ curve for charging}
      \label{fig:11.43a}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = .85]{Images/Chapter-11/11.43b}}
