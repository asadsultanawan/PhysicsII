...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = 0.8]{Images/11.4a}}
      \caption{Positive Charge}
      \label{fig:11.4a}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = 0.8]{Images/11.4b}}
...
\begin{figure}[htbp]
  \centering
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = 0.8]{Images/11.6a.png}}
      \caption{For two negative charges}
      \label{fig:11.6(a)}
  \end{subfigure}
  \begin{subfigure}[t]{0.3\textwidth}
      \fbox{\includegraphics[scale = 0.8]{Images/11.6b.png}}
